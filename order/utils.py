...
def checkout(request, firstname, lastname, email, address, city, town, phone, amount):
    order = Order.objects.create(first_name=firstname, last_name=lastname, email=email,
                                 address=address, city=city, town=town, phone=phone, paid_amount=amount)
